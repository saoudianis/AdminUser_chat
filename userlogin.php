 <doctype html>
    ...
    <div>
        ...
        <h1>Login Page</h1>
                    ...
                    /* php alert functions Enter ur info */
                    ...
                    /* if all info was right do */
                     if (($_POST["submit"]) AND (($_POST["LogPassword"]) AND ($_POST["LogEmail"]) )){
    ...
    if($row){
        ...
        header("location:chatbox.php"); 
            ...
            /* if One of the enter info are missing */
                     if (($_POST["submit"]) AND (!($_POST["LogPassword"]) OR !($_POST["LogEmail"]))){
        ...
        echo $result;
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="LogEmail" class="form-control" placeholder="Your Email" />
                        </div>   
                        
                        
                    <div class="form-group">
                        <label for="name">Your Password:</label>
                        <input type="password" name="LogPassword" class="form-control" placeholder="Your Password" />
                        </div>
                        
                        
                        
                        <input type="submit" class="btn btn-success bnt-lg" value="LogIn" name="submit" />
